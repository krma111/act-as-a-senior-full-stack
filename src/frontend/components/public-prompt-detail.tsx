...
import { PromptActions } from "@/frontend/components/prompt-actions";
import { reportPrompt } from "@/backend/actions/prompts";
import { getAuthSessionState } from "@/backend/auth/session";
import { getPrompt } from "@/backend/data/prompts";
