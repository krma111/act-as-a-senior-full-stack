      ...
      <body className="min-h-screen font-sans antialiased">
        <header className="sticky top-0 z-40 border-b border-white/10 bg-ink/80 backdrop-blur-xl">
          <nav className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-4 sm:px-6 lg:flex-nowrap lg:px-8">
            <Link href="/" className="flex items-center gap-3 text-lg font-bold tracking-normal">
              <span className="grid h-9 w-9 place-items-center rounded-lg bg-brand text-slate-950">P</span>
              {settings.logo_text}
            </Link>
