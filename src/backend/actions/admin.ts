...
import type { GeneratedPromptDraft } from "@/backend/ai/create";
import { sendFollowerApprovedPromptEmail, sendPromptApprovedEmail, sendRejectionEmail } from "@/backend/email/send";
