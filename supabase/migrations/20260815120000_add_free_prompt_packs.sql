-- PromptVault: Add 5 highly detailed FREE prompt packs
-- Additive migration: inserts/updates by slug, never deletes data.
...
(
  'Next.js SaaS Starter Kit Prompt',
  'nextjs-saas-starter-kit-prompt',
  'One highly detailed master prompt that scaffolds a complete production SaaS: auth, billing-ready tables, dashboards, admin, emails, and deployment.',
  'SaaS Startup Prompts',
  0,
  true,
  false,
  array['Codex','Cursor','Claude','ChatGPT','Replit'],
  array['Next.js','React','TypeScript','Supabase','Tailwind','Vercel'],
  'A single master prompt plus follow-up audits for auth, billing, admin, email, and deployment in one session.',
  array[
...
(
  'Production Database Schema Architect',
  'production-database-schema-architect-prompt',
  'Turns vague features into battle-tested Postgres schemas: tables, enums, indexes, triggers, RLS, and safe migrations.',
  'Database Schema Prompts',
  0,
  true,
  false,
  array['Codex','Cursor','Claude','ChatGPT'],
  array['Postgres','Supabase','SQL','RLS','Prisma'],
  'Schema design prompts, RLS builder prompts, migration safety prompts, and query performance prompts.',
  array[
...
(
  'SEO Growth Engine Master Prompt',
  'seo-growth-engine-master-prompt',
  'A complete technical + content SEO workflow: keyword strategy, metadata, structured data, sitemaps, and performance.',
  'SEO Prompts',
  0,
  true,
  false,
  array['Codex','Cursor','Claude','ChatGPT'],
  array['Next.js','Metadata API','JSON-LD','Sitemap','Core Web Vitals'],
  'Technical SEO audit prompts, metadata implementation prompts, content brief prompts, and analytics setup prompts.',
  array[
...
(
  'AI Agent Workflow Builder Prompt',
  'ai-agent-workflow-builder-prompt',
  'Designs and ships production AI agents: goals, tools, memory, guardrails, streaming UI, and cost controls.',
  'AI Agent Prompts',
  0,
  true,
  false,
  array['Codex','Cursor','Claude','ChatGPT'],
  array['TypeScript','Vercel AI SDK','Supabase','Postgres','Streaming'],
  'Agent architecture prompts, tool-building prompts, memory prompts, and safety/cost guardrail prompts.',
  array[
...
(
  'Feature Ship in One Session Prompt',
  'feature-ship-in-one-session-prompt',
  'Turns any feature request into a fully shipped feature: spec, schema, UI, tests, and deploy checklist in one session.',
  ...
  'A single end-to-end feature workflow plus QA and rollback prompts that work on any existing codebase.',
  array[
